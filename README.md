...
In this project, data collected from the accelerometers and gyroscopes of the Samsung Galaxy S smartphone was retrieved, worked with, and cleaned, to prepare a tidy data that can be used for later analysis.
